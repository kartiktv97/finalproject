...
(animation animation6 {vars : [raindrop (rectangle raindrop (position 0 0) (velocity 5 5) 20 50 "solid" "red")]
                            (animate (initialize (canvas raindrop))
                                     (until (raindrop collideswith right-edge){moveanimation}))})
